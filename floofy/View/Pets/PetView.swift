                                            ...
                                            NavigationLink(destination: DetailPetView(selectionPet: pet)) {
                                                ZStack {
                                                    ...
                                                    VStack {
                                                        HStack {
                                                            Circle()
                                                                .strokeBorder(Color(red: 216 / 255,
                                                                                    green: 31 / 255,
                                                                                    blue: 98 / 255),
                                                                              lineWidth: 2)
                                                                ...
                                                                VStack(alignment: .leading, spacing: 10) {
                                                                    ...
                                                                    VStack {
                                                                        ForEach(pet.reminderArray) { reminder in
                                                                            let dateNow = Date()
                                                                            if reminder.dateItem ?? Date() > dateNow {
                                                                                if reminder.label ?? "Unknown" == selectedLabelCategory.rawValue {
                                                                                    Text("Upcoming grooming : \(reminder.dateItem ?? Date(), style: .date)")
                                                                                        .font(.system(size: 12,
                                                                                                      weight: .regular))
                                                                                        .foregroundColor(.black)

                                                                                } else {
                                                                                    Text("Upcoming clean cage : \(reminder.dateItem ?? Date(), style: .date)")
                                                                                        .font(.system(size: 12,
                                                                                                      weight: .regular))
                                                                                        .foregroundColor(.black)
                                                                                }
