...
struct LocationListView: View {
    ...
    private func openMapsAppWithDirections(to location: Location) {
        ...
        let startCoordinate = CLLocationCoordinate2D(latitude: currentLocation.coordinate.latitude,
                                                     longitude: currentLocation.coordinate.longitude)
        let endCoordinate = CLLocationCoordinate2D(latitude: location.latitude,
